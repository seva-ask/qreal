...
namespace QReal.Web.Database
{
    ...
    public partial class GraphicInstance
    {
        public GeometryInformation GeometryInformation
        {
            get
            {
                if (this is NodeInstance)
                {
                    return (this as NodeInstance).GeometryInformation;
                }
                else if (this is EdgeInstance)
                {
                    return (this as EdgeInstance).GeometryInformation;
                }
                else
                {
                    return null;
            ...
            set
            {
                if (this is NodeInstance)
                {
                    (this as NodeInstance).GeometryInformation = value;
                }
                else if (this is EdgeInstance)
                {
                    (this as EdgeInstance).GeometryInformation = value;
                }
            }
        }
    }
