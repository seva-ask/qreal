...
-- --------------------------------------------------
-- Date Created: 08/16/2010 02:57:11
...
IF OBJECT_ID(N'[dbo].[FK_NodeInstanceGeometryInformation]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[GraphicInstances_NodeInstance] DROP CONSTRAINT [FK_NodeInstanceGeometryInformation];
GO
IF OBJECT_ID(N'[dbo].[FK_EdgeInstanceGeometryInformation]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[GraphicInstances_EdgeInstance] DROP CONSTRAINT [FK_EdgeInstanceGeometryInformation];
GO
...
-- Creating foreign key on [GeometryInformationId] in table 'GraphicInstances_NodeInstance'
ALTER TABLE [dbo].[GraphicInstances_NodeInstance]
...
-- Creating foreign key on [GeometryInformationId] in table 'GraphicInstances_EdgeInstance'
ALTER TABLE [dbo].[GraphicInstances_EdgeInstance]
