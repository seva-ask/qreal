...
namespace QReal.Controls
{
    public class CanvasDDTarget : ItemsControlDragDropTarget<CanvasItemsControl, ObjectType>
    {
        ...
        protected override bool CanAddItem(CanvasItemsControl itemsControl, object data)
        {
            ...
            return ((Activator.CreateInstance(type) as ObjectType).CanBeRootElement || (InstancesManager.Instance.CanvasRootElement != null));
        }
        ...
        protected override void OnDropOverride(Microsoft.Windows.DragEventArgs args)
        {
            ...
            if (CanAddItem(null, type))
            {
                ...
                if ((InstancesManager.Instance.CanvasRootElement == null) && ((Activator.CreateInstance(type) as ObjectType).CanBeRootElement))
                {
                ...
                else
                {
                    ...
                    if (graphicVisualizedInstance.Parent == null)
                    {
                        graphicVisualizedInstance.Parent = InstancesManager.Instance.CanvasRootElement;
                    }
